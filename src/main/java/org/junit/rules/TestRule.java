 ...
 * methods annotated with {@link org.junit.annotation.Before},
 * {@link org.junit.annotation.After}, {@link org.junit.annotation.BeforeClass}, or
 * {@link org.junit.annotation.AfterClass}, but they are more powerful, and more easily
 * shared
 ...
 * ways.  {@link org.junit.annotation.Rule} annotates method-level
 * {@link TestRule}s, and {@link org.junit.annotation.ClassRule}
 ...
 * {@link org.junit.annotation.Rule} in turn, and each may return a substitute or modified
 * {@link Statement}, which is passed to the next {@link org.junit.annotation.Rule}, if any. For
